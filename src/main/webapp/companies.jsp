	...
	<body>
	 	 	...
	 	 	<div id="top" class="row">
			    ...
			    <div class="col-md-6">
			        <div class="input-group h2">
			            <input name="data[search]" class="form-control" id="search" type="text" placeholder="Pesquisar companhias">
			    ...
			    <div class="col-md-3">
			        <a href="/crud-manager/company/form" class="btn btn-danger pull-right h2"><span class="glyphicon glyphicon-plus" /></span>&nbspAdicionar Companhia</a>
			    </div>
	     	</div>
		...
		<script type="text/javascript">
			$(document).ready(function() {
			    ...
			    // ao clicar no delete de algum post, pega o nome da companhia, 
			    // o id do companhia e a ação (delete) e envia para o modal 
			    $(".modal-remove").click(function () {
		            var companyName = $(this).attr('company-name');
		            var companyId = $(this).attr('company-id');
		            $(".modal-body #hiddenValue").text("a companhia '"+companyName+"'");
